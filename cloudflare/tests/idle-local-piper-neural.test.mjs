...
for(const token of [
  ...
  '<script type="module" src="/modules/local-neural-piper-v1.js?v=12"></script>',
  '/modules/tutorial-tts-v202.js?v=234'
]){
...
assert.ok(
  ...
  index.indexOf('/modules/local-neural-piper-v1.js?v=12'),
  "Le phonémiseur espeak-ng doit être chargé avant le module Piper local."
);
assert.ok(
  index.indexOf('/modules/local-neural-piper-v1.js?v=12')<
  index.indexOf('/modules/tutorial-tts-v202.js?v=234'),
