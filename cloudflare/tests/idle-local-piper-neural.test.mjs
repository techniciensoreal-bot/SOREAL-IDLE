...
for(const token of [
  ...
  '<script type="module" src="/modules/local-neural-piper-v1.js?v=13"></script>',
  '/modules/tutorial-tts-v202.js?v=235'
]){
...
assert.ok(
  ...
  index.indexOf('/modules/local-neural-piper-v1.js?v=13'),
  "Le phonémiseur espeak-ng doit être chargé avant le module Piper local."
);
assert.ok(
  index.indexOf('/modules/local-neural-piper-v1.js?v=13')<
  index.indexOf('/modules/tutorial-tts-v202.js?v=235'),
 ...
 */
{
  ...
  assert.ok(local.includes("normalizeEllipsis_(normalizeAsterisks_(normalizePronunciation_(sanitizeText_(text))))"),"la synthèse nettoie aussi le texte (prononciation comprise)");
}
