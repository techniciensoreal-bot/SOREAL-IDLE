...
{
  let s = normalizeIdleAdventureStateV47({});
  let r = applyIdleAdventureActionV47(s, { action: "addItem", definitionId: "forest:weapon", level: 100 }, { bosses: 17 }, 1);
  s = r.state;
...
{
  let s = normalizeIdleAdventureStateV47({});
  // Fusionne un objet niveau 50 (jamais boosté) avec un objet niveau 49 : résultat niveau 100,
