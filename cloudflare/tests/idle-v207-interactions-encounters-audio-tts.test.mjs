...
assert.ok(index.includes("/modules/audio-effects-v199.js?v=207"));
assert.ok(index.includes("/modules/tutorial-tts-v202.js?v=207"));
assert.ok(index.includes("/soreal-idle-ui.js?v=207"));
