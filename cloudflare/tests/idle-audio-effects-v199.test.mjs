...
assert.ok(
  index.includes('/modules/audio-effects-v199.js?v=199')&&
  index.includes('/modules/long-press-v197.js?v=199')&&
  index.includes('/soreal-idle-ui.js?v=199')&&
  index.indexOf('/modules/audio-effects-v199.js?v=199')<
    index.indexOf('/soreal-idle-ui.js?v=199'),
