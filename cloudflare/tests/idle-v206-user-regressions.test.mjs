...
assert.ok(index.includes("/modules/audio-effects-v199.js?v=210")&&index.includes("/modules/tutorial-tts-v202.js?v=210")&&index.includes("/soreal-idle-ui.js?v=210"),"Assets V207 non cache-bustés.");
...
assert.ok(ui.includes('Build <b style="color:#dce5f3">V210</b>'),"Settings doit afficher V208.");
new Function(ui);
