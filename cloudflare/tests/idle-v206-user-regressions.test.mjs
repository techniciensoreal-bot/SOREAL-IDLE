...
assert.ok(index.includes("/modules/audio-effects-v199.js?v=206")&&index.includes("/modules/tutorial-tts-v202.js?v=206")&&index.includes("/soreal-idle-ui.js?v=206"),"Assets V206 non cache-bustés.");
...
assert.ok(ui.includes('Build <b style="color:#dce5f3">V206</b>'),"Settings doit afficher V206.");
new Function(ui);
new Function("window","document",audio);
new Function("window","document","localStorage",tts);
console.log("SOREAL IDLE V206: OK — loader, Boss 6, Fight explicite, audio, Money Pit et chroniques TTS.");