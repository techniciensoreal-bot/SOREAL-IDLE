...
assert.equal(IDLE_PERKS_CATALOG_V1.length, 173, "56 Normal-accessible perks (0-55) + Fibonacci Perk (94) + 56 Evil/Sadistic-tier perks + perk 86 (garderie) + 10 perks MacGuffin + 12 perks de Questing (87, 89-92, 104-106, 145-148, 2026-09-23).");
for (let i = 0; i < 56; i++) {
