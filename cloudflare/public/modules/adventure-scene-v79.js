...
(function(){
  ...
  function scene_(root,a){
    ...
    block.innerHTML=''
      ...
      +        '<div data-player-stat="power">Power: <b class="soreal-idle-v79-stat-base"></b><b class="soreal-idle-v79-stat-bonus"></b><b class="soreal-idle-v79-stat-cube"></b></div>'
      +        '<div data-player-stat="toughness">Toughness: <b class="soreal-idle-v79-stat-base"></b><b class="soreal-idle-v79-stat-bonus"></b><b class="soreal-idle-v79-stat-cube"></b></div>'
      +        '<div data-player-stat="hp">Max HP: <b class="soreal-idle-v79-stat-base"></b><b class="soreal-idle-v79-stat-bonus"></b></div>'
      +        '<div data-player-stat="regen">HP Regen/s: <b class="soreal-idle-v79-stat-base"></b><b class="soreal-idle-v79-stat-bonus"></b></div>'
      +      '</div>'
      +    '</div>'
      +    '<div class="soreal-idle-v79-enemy-card soreal-idle-v79-stat-card" style="visibility:hidden">'
      +      '<div class="soreal-idle-v79-card-name"></div>'
      +      '<div class="soreal-idle-v79-stat-lines">'
      +        '<div>Power: <b data-enemy-stat="power"></b></div>'
      +        '<div>Toughness: <b data-enemy-stat="toughness"></b></div>'
      +        '<div>Max HP: <b data-enemy-stat="hp"></b></div>'
      +        '<div>HP Regen/s: <b data-enemy-stat="regen"></b></div>'
      +        '<div>Type: <b data-enemy-stat="type"></b></div>'
      +      '</div>'
      +    '</div>'
      +  '</div>'
      +'</div>';
