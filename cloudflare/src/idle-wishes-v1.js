...
export const IDLE_WISHES_CATALOG_V1 = Object.freeze([
  ...
  { id: 19, name: "I wish Active Quests were more Rewarding I", effect: "We'll have our guys talk to the Beast, we can work something out. How's 2% better active questing rewards per level sound?", levels: 10, speedDivider: 2.00e16, bonus: { questActiveRewardPct: 0.02 } },
  ...
  { id: 47, name: "I wish Quests gave more QP", effect: "Alright, just don't tell the Beast! This wish will improve Quest QP rewards by 2% per level!", levels: 10, speedDivider: 3.00e18, bonus: { questQpPct: 0.02 } },
  ...
  { id: 62, name: "I wish Active Quests were more Rewarding II", effect: "Oof, this a big favour to ask of us again, but we'll try. How's another 1% better active questing rewards per level sound?", levels: 10, speedDivider: 8.00e20, bonus: { questActiveRewardPct: 0.01 } },
  ...
  { id: 80, name: "I wish higher level quest drops counted for even more Quest progress I", effect: "Alright - This wish will reduce the level divider for higher level Quest handins by 1 for each level of this perk! Originally the formula is 1 + (level/10), rounded down.", levels: 2, speedDivider: 5.00e17, bonus: { questHandinReduction: 1 } },
  { id: 81, name: "I wish higher level quest drops counted for even more Quest progress II", effect: "This wish will additionally reduce the level divider for higher level Quest handins by 1 for each level of this perk! Originally the formula is 1 + (level/10), rounded down.", levels: 2, speedDivider: 1.00e22, bonus: { questHandinReduction: 1 } },
  ...
  { id: 88, name: "I wish I had more Resource 3 Power V", effect: "Sure, why not! This wish will grant +3% Resource 3 Power per level!", levels: 10 /* wiki Resource 3 : 10 niveaux (la page Wishes dit 1, coquille) ; source tierce : 10 */, speedDivider: 5.00e21, bonus: { r3PowerPct: 0.03 } },
  { id: 89, name: "I wish I had more Resource 3 Barfs V", effect: "Sure, why not! This wish will grant +1.5% Resource 3 Bars per - wait, does the wish name say barfs?", levels: 10 /* wiki Resource 3 : 10 niveaux (la page Wishes dit 1, coquille) ; source tierce : 10 */, speedDivider: 5.00e21, bonus: { r3BarsPct: 0.015 } },
  ...
  { id: 91, name: "I wish I had more Energy Power VI", effect: "Okay fine! This wish will grant +2% Energy Power per level!", levels: 10, speedDivider: 1.00e23 /* wiki Wishes : data-sort-value 1e23 (le texte affiché « 1.00E+21 » est une coquille, la ligne 92 voisine est à 1e23) ; source tierce 1e23 */, bonus: { energyPowerPct: 0.02 } },
  ...
  { id: 101, name: "I wish Major Quests had better Base QP Rewards.", effect: "Every level of this wish improves base QP reward for Major Quests by 1 per level!", levels: 10, speedDivider: 1.00e22, bonus: { questMajorBaseQp: 1 } },
  { id: 102, name: "I wish Minor Quests had better Base QP Rewards.", effect: "Every level of this wish improves base QP reward for Minor Quests by 1 per level!", levels: 2, speedDivider: 1.80e23, bonus: { questMinorBaseQp: 1 } },
  ...
  { id: 189, name: "I wish I could beat up more bosses V", effect: "Now with 20 levels, woooah! Also, right, this gives 1% more Attack/Defense per level.", levels: 20, speedDivider: 1.00e24, bonus: { statPct: 1.00 /* +100 %/niveau : la série « bosses » I-IV, VI-VIII est à +100 % ; le texte « 1 % » du wiki est copié du souhait 188 ; source tierce +100 */ } },
