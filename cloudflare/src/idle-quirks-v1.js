...
export const IDLE_QUIRKS_CATALOG_V1 = Object.freeze([
  ...
  { id: 10, name: "The Beast's Special Beard Tonic", effect: "Don't ask what it's made out of, but it boosts your Beard Speed by 1% per level!", cost: 50, cap: 50, bonus: { beardSpeedPct: 0.01 } },
...
export function quirkBonusesV1(levelsById) {
  ...
  return {
    ...
    beardSpeedMultiplier: 1 + (totals.beardSpeedPct || 0),
